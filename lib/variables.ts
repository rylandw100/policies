...
export function generateTriggerVariables(): VariableNode {
  return {
    ...
    name: "Trigger event",
    type: "step",
    stepName: "Start date at 9:00 AM PST",
    stepId: "ID: 1",
    stepIcon: "zap",
    children: [
      {
...
// Generate variable structure for Health check step
...
export type SelectedNode = "trigger" | "aiPrompt" | "widget" | null;
